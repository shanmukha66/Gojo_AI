...
function validatePayload(body: Payload) {
  ...
  if (body.doctorCopilotMode !== undefined) {
    if (body.doctorCopilotMode !== "assist" && body.doctorCopilotMode !== "strict") {
      return { error: "Invalid doctorCopilotMode" };
    }
    patch.doctorCopilotMode = body.doctorCopilotMode;
  }
